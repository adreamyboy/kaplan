...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_MANAGE_SECURITYGROUPS_TITLE' => 'SecuritySuite Group Management',
  'LBL_MANAGE_SECURITYGROUPS' => 'SecuritySuite Group Editor',
  'LBL_SECURITYGROUPS' => 'SecuritySuite',
  'LBL_CONFIG_SECURITYGROUPS_TITLE' => 'SecuritySuite Settings',
  'LBL_CONFIG_SECURITYGROUPS' => 'Configure Security Suite settings such as group inheritance, additive security, etc',
  'LBL_SECURITYGROUPS_UPGRADE_INFO_TITLE' => 'Get All Features!',
  'LBL_SECURITYGROUPS_INFO_TITLE' => 'Documentation',
  'LBL_SECURITYGROUPS_INFO' => 'Learn more about the many features and options that SecuritySuite comes packed with.',
  ...
  'LBL_SECURITYGROUPS_SUGAROUTFITTERS_TITLE' => 'SugarOutfitters.com',
  'LBL_SECURITYGROUPS_SUGAROUTFITTERS' => 'See more handpicked solutions for Community Edition.',
  ...
  'LBL_FIELDSACL_ADMIN' => 'Field Level Access',
  'LBL_FIELDSACL_ADMIN_DESCRIPTION' => 'Manage Field Level Access',
  'LBL_FIELDSACL_ADMIN_TITLE' => 'Field Level Access',
  'FIELDSACL_ADMIN_TITLE' => 'Field Level Access',
  'FIELDSACL_ADMIN_DESC' => 'Manage Field Level Access',
  'LBL_SECURITYGROUPS_UPGRADE_INFO' => 'Start benefiting from the many features that Full Edition comes with including fast debugging, custom group layouts, and more.',
  'LBL_SECURITYGROUPS_LICENSE_TITLE' => 'License Configuration',
  'LBL_SECURITYGROUPS_LICENSE' => 'Manage and configure the license for this add-on',
);