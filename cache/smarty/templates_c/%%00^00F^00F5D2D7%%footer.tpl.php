<?php /* Smarty version 2.6.29, created on 2022-06-10 09:33:09
...
">
    	...
    	<div class="footer_right">
    		...
    		<a onclick="SUGAR.util.top();" href="javascript:void(0)"><?php echo $this->_tpl_vars['MOD']['LBL_SUITE_TOP']; ?>
</a>
    	</div>
    </footer>
    <!-- END Generic Footer -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="title-generic"><?php echo $this->_tpl_vars['MOD']['LBL_GENERATE_PASSWORD_BUTTON_TITLE']; ?>
</h4>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-default" type="button" data-dismiss="modal"><?php echo $this->_tpl_vars['MOD']['LBL_CANCEL']; ?>
</button>
                <button id="btn-generic" class="btn btn-danger" type="button"><?php echo $this->_tpl_vars['MOD']['LBL_OK']; ?>
</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
