...
class NoteSoap
{
    ...
    function saveFile($note, $portal = false)
    {
        ...
        if(!empty($note['file'])){
                ...
                // Tawfeeq Jaafar: added to fix SugarCRM-Outlook connector issue.
                $note['file'] = str_replace(" ", '+', $note['file']); 
                // The plugin base64 encodes attachments with " " instead of "+", then PHP base64_decode misreads string with spaces.
                // See here: https://suitecrm.com/forum/suitecrm-outlook-plugin/3070-bug-attachments-corrupted-files
