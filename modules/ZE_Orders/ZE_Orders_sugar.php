...
class ZE_Orders_sugar extends Basic
{
    public $new_schema = true;
    public $module_dir = 'ZE_Orders';
    public $object_name = 'ZE_Orders';
    public $table_name = 'ze_orders';
