...
if(isset($focus->campaign_type) && $focus->campaign_type == "NewsLetter"){
    ...
    if(isset($focus->campaign_type) && $focus->campaign_type == "Email" || $focus->campaign_type == "NewsLetter") {
        ...
        $smarty->assign("TRACK_DELETE_DUPLICATE_BUTTON","<input title=\"{$mod_strings['LBL_DUPLICATE_DELETE_BUTTON_TITLE']}\"   class=\"DeleteDuplicate\" onclick=\"this.form.module.value='Campaigns'; this.form.action.value='DeleteDuplicate';this.form.return_module.value='Campaigns'; this.form.return_action.value='TrackDetailView';\"  type=\"submit\" name=\"button\" value=\"  {$mod_strings['LBL_DUPLICATE_DELETE_BUTTON_LABEL']}  \">");  
