...
class SugarWidgetSubPanelTopSendSmsButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		$this->module="GI_SMS_Messages";
		$this->subpanelDiv = "activities";
		$this->form_name = 'Send SMS';
		...
		$button .= "<input class='button' type='submit' name='button' value='Send SMS'>\n"; // refer to: xxxxxxxx
