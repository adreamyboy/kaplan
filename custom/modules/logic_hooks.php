...
$hook_array['after_save'][] = Array(1, 'popup_onload', 'modules/AOD_Index/AOD_LogicHooks.php','AOD_LogicHooks', 'saveModuleChanges'); 
...
$hook_array['after_delete'][] = Array(1, 'popup_onload', 'modules/AOD_Index/AOD_LogicHooks.php','AOD_LogicHooks', 'saveModuleDelete'); 
...
$hook_array['after_restore'][] = Array(1, 'popup_onload', 'modules/AOD_Index/AOD_LogicHooks.php','AOD_LogicHooks', 'saveModuleRestore'); 
