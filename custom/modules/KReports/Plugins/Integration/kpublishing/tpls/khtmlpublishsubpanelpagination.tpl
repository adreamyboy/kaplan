<tr class="pagination" role=”presentation”>
    <td colspan='{$colCount}' align='right'>
        <table border='0' cellpadding='0' cellspacing='0' width='100%'>
            <tr>
                <td align='left'><img id="loader{$pageData.subpanelname}" style="display:none;" src="themes/default/images/bar_loader.gif"></td>
                <td align='right' nowrap='nowrap'>
                    {if $pageData.urls.startPage}
                        <button class="button" onclick="document.getElementById('loader{$pageData.subpanelname}').style.display='inline';javascript:showSubPanel('{$pageData.subpanelname}','{$pageData.urls.startPage}',true);;" title="Start" name="listViewStartButton" type="button">
                    ...
                    {if $pageData.urls.prevPage}
                        <button class="button" onclick="document.getElementById('loader{$pageData.subpanelname}').style.display='inline';javascript:showSubPanel('{$pageData.subpanelname}','{$pageData.urls.prevPage}',true);;" title="Previous" name="listViewPreviousButton" type="button">
                    ...
                    {if $pageData.urls.nextPage}
                        <button class="button" onclick="document.getElementById('loader{$pageData.subpanelname}').style.display='inline';javascript:showSubPanel('{$pageData.subpanelname}','{$pageData.urls.nextPage}',true);;" title="Next" name="listViewNextButton" type="button">
                    ...
                    {if $pageData.urls.endPage  && $pageData.offsets.total != $pageData.offsets.lastOffsetOnPage}
                        <button class="button" onclick="document.getElementById('loader{$pageData.subpanelname}').style.display='inline';javascript:showSubPanel('{$pageData.subpanelname}','{$pageData.urls.endPage}',true);;" title="End" name="listViewEndButton" type="button">
