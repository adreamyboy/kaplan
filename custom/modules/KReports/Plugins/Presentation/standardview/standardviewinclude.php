...
//function standarddetailviewdisplay(&$thisview) {
   public function display($thisReport) {
      ...
      $viewJS .= '<script type="text/javascript" src="custom/modules/KReports/Plugins/Presentation/standardview/js/viewstandard' . ($GLOBALS['sugar_config']['KReports']['debug'] ? '_debug' : '') . '.js"></script>';
