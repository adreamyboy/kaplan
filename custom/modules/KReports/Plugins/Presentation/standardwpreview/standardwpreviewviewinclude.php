...
class kreportpresentationstandardwp extends kreportpresentationplugin {
   ...
   public function display($thisReport) {
      ...
      $viewJS .= '<script type="text/javascript" src="custom/modules/KReports/Plugins/Presentation/standardwpreview/js/viewstandardwpreview' . ($GLOBALS['sugar_config']['KReports']['debug'] ? '_debug' : '') . '.js"></script>';
      return $viewJS;
   }
