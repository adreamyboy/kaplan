...
/*
This action sends a ThankYou/Confirmation email to both "Referring" & "Referred" customers.
...
$bean = $this->bean;
if (sendReferralConfirmationViaEmail($bean, '9ea29696-87ea-e7ca-da7a-56b77a7c230a')) {
} else {
}
$params = array(
...
function sendReferralConfirmationViaEmail($opportunity, $templateID) {
	...
	$mail->From = 'info@kaplangenesis.com';  // $defaults['email']; // always send it from 'info@genesisreview.com' (instead of the default 'promotions@genesisreview.com')
