<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    'awarded_certifications_c' => 
    array (
      'labelValue' => 'Awarded Certifications',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'awarded_certifications_c',
      'vname' => 'LBL_AWARDED_CERTIFICATIONS',
      'type' => 'multienum',
      'massupdate' => '1',
      'default' => NULL,
      'no_default' => false,
      ...
      'merge_filter' => 'disabled',
      'size' => '20',
      'options' => 'awarded_certifications_list',
      'studio' => 'visible',
      'isMultiSelect' => true,
      'id' => 'Contactsawarded_certifications_c',
      'custom_module' => 'Contacts',
    ),
    'do_not_sms_c' => 
    array (
      'labelValue' => 'Do Not SMS',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'do_not_sms_c',
      'vname' => 'LBL_DO_NOT_SMS',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsdo_not_sms_c',
      'custom_module' => 'Contacts',
    ),
    'generate_new_password_c' => 
    array (
      'labelValue' => 'Generate New Password?',
      'massupdate' => true,
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'generate_new_password_c',
      'vname' => 'LBL_GENERATE_NEW_PASSWORD',
      'type' => 'bool',
      'default' => '0',
      'no_default' => false,
      'comments' => '',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsgenerate_new_password_c',
      'custom_module' => 'Contacts',
    ),
    'is_instructor_c' => 
    array (
      'labelValue' => 'Is Instructor',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'is_instructor_c',
      'vname' => 'LBL_IS_INSTRUCTOR',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsis_instructor_c',
      'custom_module' => 'Contacts',
    ),
    'login_last_date_sent_c' => 
    array (
      'labelValue' => 'Login Last Date Sent',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'login_last_date_sent_c',
      'vname' => 'LBL_LOGIN_LAST_DATE_SENT',
      'type' => 'datetimecombo',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'dbType' => 'datetime',
      'id' => 'Contactslogin_last_date_sent_c',
      'custom_module' => 'Contacts',
    ),
    'password_c' => 
    array (
    ...
    'send_login_immediately_c' => 
    array (
      'labelValue' => 'Send Login Immediately?',
      'massupdate' => true,
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'send_login_immediately_c',
      'vname' => 'LBL_SEND_LOGIN_IMMEDIATELY',
      'type' => 'bool',
      'default' => '0',
      'no_default' => false,
      'comments' => '',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactssend_login_immediately_c',
      'custom_module' => 'Contacts',
    ),
    'send_reset_link_immediately_c' => 
    array (
      'labelValue' => 'Send Reset Link Immediately?',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'send_reset_link_immediately_c',
      'vname' => 'LBL_SEND_RESET_LINK_IMMEDIATELY',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactssend_reset_link_immediately_c',
      'custom_module' => 'Contacts',
    ),
    'university_c' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'User Status',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'user_error_c',
      'vname' => 'LBL_USER_ERROR',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
