<?php 
 $GLOBALS["dictionary"]["Lead"]=array (
  ...
  array (
    ...
    'company_c' => 
    array (
      'labelValue' => 'Company (experimental - do not use)',
      'required' => false,
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Leadscompany_sponsored_c',
      'custom_module' => 'Leads',
    ),
    'coupon_code_c' => 
    array (
      'labelValue' => 'Coupon Code',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'coupon_code_c',
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Leadscoupon_code_c',
      'custom_module' => 'Leads',
    ),
    'current_url_c' => 
    array (
      'labelValue' => 'Current URL',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'current_url_c',
      'vname' => 'LBL_CURRENT_URL',
      'type' => 'url',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'gen' => NULL,
      'link_target' => '_blank',
      'id' => 'Leadscurrent_url_c',
      'custom_module' => 'Leads',
    ),
    'email_verification_date_sent_c' => 
    array (
      'labelValue' => 'Email Verification Date Sent',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'email_verification_date_sent_c',
      'vname' => 'LBL_EMAIL_VERIFICATION_DATE_SENT',
      'type' => 'datetimecombo',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'dbType' => 'datetime',
      'id' => 'Leadsemail_verification_date_sent_c',
      'custom_module' => 'Leads',
    ),
    'email_verified_by_customer_c' => 
    array (
      'labelValue' => 'Email Verified By Customer (experimental - do not use)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'email_verified_by_customer_c',
      'vname' => 'LBL_EMAIL_VERIFIED_BY_CUSTOMER',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Leadsemail_verified_by_customer_c',
      'custom_module' => 'Leads',
    ),
    'payment_mode_c' => 
    array (
      ...
      'dbType' => 'enum',
      'separator' => '<br>',
      'id' => 'Leadspayment_mode_c',
      'custom_module' => 'Leads',
    ),
    'product_c' => 
    array (
      'labelValue' => 'Product (experimental - do not use)',
      'required' => false,
      'source' => 'non-db',
      'name' => 'product_c',
      'vname' => 'LBL_PRODUCT',
    ...
    'referral_url_c' => 
    array (
      'labelValue' => 'Referral URL',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'referral_url_c',
      'vname' => 'LBL_REFERRAL_URL',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '40',
      'id' => 'Leadsreferral_url_c',
      'custom_module' => 'Leads',
    ),
    'send_coupon_via_email_c' => 
    array (
      'labelValue' => 'Send Coupon Via Email',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'send_coupon_via_email_c',
      'vname' => 'LBL_SEND_COUPON_VIA_EMAIL',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Leadssend_coupon_via_email_c',
      'custom_module' => 'Leads',
    ),
    'send_email_verification_link_c' => 
    array (
      'labelValue' => 'Send Email Verification Link',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'send_email_verification_link_c',
      'vname' => 'LBL_SEND_EMAIL_VERIFICATION_LINK',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Leadssend_email_verification_link_c',
      'custom_module' => 'Leads',
    ),
    'form_url_c' => 
    array (
    ...
    array (
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'gi_products_id_c',
      'vname' => 'LBL_PRODUCT_GI_PRODUCTS_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
