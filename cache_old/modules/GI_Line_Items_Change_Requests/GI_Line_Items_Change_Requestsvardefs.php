<?php 
 $GLOBALS["dictionary"]["GI_Line_Items_Change_Requests"]=array (
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'gi_line_items_change_requests_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'gi_line_items_change_requests_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'gi_line_items_change_requests_assigned_user',
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'GI_Line_Items_Change_Requestsdiscontinued_c',
      'custom_module' => 'GI_Line_Items_Change_Requests',
    ),
    'limit_to_capacity_c' => 
    array (
      'labelValue' => 'Limit to Capacity / Approve Automatically',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'limit_to_capacity_c',
      'vname' => 'LBL_LIMIT_TO_CAPACITY',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '1',
      'no_default' => false,
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'GI_Line_Items_Change_Requestslimit_to_capacity_c',
      'custom_module' => 'GI_Line_Items_Change_Requests',
    ),
  ),
  'relationships' => 
  ...
  array (
    'id' => 
    array (
      'name' => 'gi_line_items_change_requestspk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
