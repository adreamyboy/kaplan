 ...
 $GLOBALS["dictionary"]["Campaign"]=array (
  ...
  array (
    ...
    array (
      ...
      'display_default' => 'now',
      'required' => true,
      'comments' => 'Starting date of the campaign',
      'merge_filter' => 'disabled',
    ),
    'end_date' => 
    array (
    ...
    'gi_products_campaigns_1gi_products_ida' => 
    array (
    ...
    'gi_products_categories_campaigns_1_name' => 
    array (
    ...
    'gi_products_categories_campaigns_1gi_products_categories_ida' => 
    array (
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'compaign_department_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Campaignsdepartment_c',
      'custom_module' => 'Campaigns',
    ),
    'show_on_web_c' => 
    array (
      'labelValue' => 'Show On Web',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'show_on_web_c',
