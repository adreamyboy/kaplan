...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'GI_Products'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'GI_Products'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_accounts_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_accounts_gi_products_1_name_advanced","accounts_gi_products_1accounts_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_gi_products_1accounts_ida"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_exam_results_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Exam_Results"],"group":"or","field_list":["name","id"],"populate_list":["gi_exam_results_gi_products_1_name_advanced","gi_exam_results_gi_products_1gi_exam_results_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_line_items_change_requests_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Line_Items_Change_Requests"],"group":"or","field_list":["name","id"],"populate_list":["gi_line_items_change_requests_gi_products_1_name_advanced","gi_line_itcd35equests_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_line_items_change_requests_gi_products_2_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Line_Items_Change_Requests"],"group":"or","field_list":["name","id"],"populate_list":["gi_line_items_change_requests_gi_products_2_name_advanced","gi_line_it60abequests_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_locations_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Locations"],"group":"or","field_list":["name","id"],"populate_list":["gi_locations_gi_products_1_name_advanced","gi_locations_gi_products_1gi_locations_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_products_catalog_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Products_Catalog"],"group":"or","field_list":["name","id"],"populate_list":["gi_products_catalog_gi_products_1_name_advanced","gi_products_catalog_gi_products_1gi_products_catalog_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_gi_terms_gi_products_1_name_advanced\']={"form":"search_form","method":"query","modules":["GI_Terms"],"group":"or","field_list":["name","id"],"populate_list":["gi_terms_gi_products_1_name_advanced","gi_terms_gi_products_1gi_terms_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>