<?php /* Smarty version 2.6.29, created on 2022-06-07 11:35:59
         compiled from cache/themes/SuiteR/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 33, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 38, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 39, false),array('function', 'sugar_phone', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 121, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 237, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 51, false),array('modifier', 'escape', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 292, false),array('modifier', 'url2html', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 292, false),array('modifier', 'nl2br', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 292, false),array('modifier', 'substr', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 348, false),array('modifier', 'to_url', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 350, false),array('modifier', 'strip_tags', 'cache/themes/SuiteR/modules/Accounts/DetailView.tpl', 410, false),)), $this); ?>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['tier_c']['hidden']): ?>
...
<?php if (is_string ( $this->_tpl_vars['fields']['tier_c']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tier_c']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['tier_c']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['tier_c']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['tier_c']['options'][$this->_tpl_vars['fields']['tier_c']['value']]; ?>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['contacts_accounts_1_name']['hidden']): ?>
...
<?php if (! empty ( $this->_tpl_vars['fields']['contacts_accounts_1contacts_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Contacts&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['contacts_accounts_1contacts_ida']['value']; ?>
...
"><?php endif; ?>
<span id="contacts_accounts_1contacts_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1contacts_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['contacts_accounts_1contacts_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
</td>
...
<td width='12.5%' scope="row">
<?php if (! $this->_tpl_vars['fields']['individual_c']['hidden']): ?>
...
<?php endif; ?>
<input type="checkbox" class="checkbox" name="<?php echo $this->_tpl_vars['fields']['individual_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['individual_c']['name']; ?>
" value="$fields.individual_c.value" disabled="true" <?php echo $this->_tpl_vars['checked']; ?>
>
<?php endif; ?>
</td>
...
<?php if ($this->_tpl_vars['bean']->field_defs['billing_address_street']['acl'] < 1): ?>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['shipping_address_street']['acl'] < 1): ?>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
