<?php /* Smarty version 2.6.29, created on 2022-06-07 12:31:34
         compiled from cache/themes/SuiteR/modules/Users/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 4, false),array('function', 'sugar_action_menu', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 93, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 114, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 119, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 123, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 201, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 229, false),array('function', 'sugar_help', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 1343, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 1677, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 120, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 133, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 226, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 328, false),array('modifier', 'strstr', 'cache/themes/SuiteR/modules/Users/EditView.tpl', 1284, false),)), $this); ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_USER_INFORMATION','module' => 'Users'), $this);?>
</h4>
</th>
</tr>
...
<?php if ($this->_tpl_vars['bean']->field_defs['user_name']['acl'] < 1): ?>
<td valign="top" id='user_name_label' width='12.5%' scope="row">
...
<?php if ($this->_tpl_vars['bean']->field_defs['UserType']['acl'] < 1): ?>
<td valign="top" id='UserType_label' width='12.5%' scope="row">
...
<?php if ($this->_tpl_vars['bean']->field_defs['picture']['acl'] < 1): ?>
<td valign="top" id='picture_label' width='12.5%' scope="row">
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php endif; ?>
<div id="LBL_EMPLOYEE_INFORMATION">
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','start' => 0,'print' => false,'assign' => 'panelFieldCount'), $this);?>
...
<tr>
<th align="left" colspan="8">
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMPLOYEE_INFORMATION','module' => 'Users'), $this);?>
</h4>
</th>
</tr>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed','start' => 0,'print' => false,'assign' => 'fieldsUsed'), $this);?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['employee_status']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['show_on_employees']['acl'] < 1): ?>
<td valign="top" id='show_on_employees_label' width='12.5%' scope="row">
...
<?php if ($this->_tpl_vars['bean']->field_defs['reports_to_name']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['phone_other']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['messenger_type']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['messenger_id']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['phone_home']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['address_street']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['address_city']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['address_state']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['address_postalcode']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['address_country']['acl'] < 1): ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NOTES','module' => 'Users'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
</textarea><?php echo '<script type="text/javascript" language="Javascript" src="include/javascript/tiny_mce/tiny_mce.js?v=xnWEBJc8xvNdS4iSEgE4ng"></script>
...
<?php if ($this->_tpl_vars['bean']->field_defs['photo']['acl'] < 1): ?>
<td valign="top" id='photo_label' width='12.5%' scope="row">
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=QYEjJigJFac8004a7_xjhQ'></script>
...
<?php if (((is_array($_tmp=$this->_tpl_vars['fields']['photo']['value'])) ? $this->_run_mod_handler('strstr', true, $_tmp, 'http') : strstr($_tmp, 'http'))): ?>
<a href="<?php echo $this->_tpl_vars['fields']['photo']['value']; ?>
"</a>
<?php else: ?>
...
<td width="30%" ><slot><input type="text" id="mail_smtpuser" name="mail_smtpuser" size="25" maxlength="255" value="<?php echo $this->_tpl_vars['mail_smtpuser']; ?>
" tabindex='1' ></slot></td>
<td>&nbsp;</td>
<td >&nbsp;</td>
</tr>
...
<td width="30%" ><slot>
<input type="password" id="mail_smtppass" name="mail_smtppass" size="25" maxlength="255" value="<?php echo $this->_tpl_vars['mail_smtppass']; ?>
" tabindex='1'>
...
<span class="required" id="mandatory_pwd"><?php if (( $this->_tpl_vars['REQUIRED_PASSWORD'] )): ?><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
<?php endif; ?></span>
</td>
<td class='dataField'>
...
</table><?php echo $this->_tpl_vars['overlibStuff']; ?>
