...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/SugarFields/Fields/Image/EditView.tpl', 42, false),array('function', 'sugarvar', 'include/SugarFields/Fields/Image/EditView.tpl', 55, false),array('modifier', 'default', 'include/SugarFields/Fields/Image/EditView.tpl', 114, false),)), $this); ?>
{*
/*********************************************************************************
...
_old" style="display:{if !$showRemove}none;{/if}">
  ...
  {if $fields.<?php echo $this->_tpl_vars['vardef']['name']; ?>
.value|strstr:"http"}
    <a href="{$fields.<?php echo $this->_tpl_vars['vardef']['name']; ?>
.value}"</a>
  {else}
