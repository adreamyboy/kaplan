<?php /* Smarty version 2.6.29, created on 2022-06-07 11:27:16
         compiled from cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/GI_Line_Items_Change_Requests/SearchForm_popup_query_form.tpl', 163, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'GI_Line_Items_Change_Requests'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='limit_to_capacity_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_LIMIT_TO_CAPACITY','module' => 'GI_Line_Items_Change_Requests'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['limit_to_capacity_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['limit_to_capacity_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['limit_to_capacity_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['limit_to_capacity_c_advanced']['name']; ?>
"   >
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='discontinued_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DISCONTINUED','module' => 'GI_Line_Items_Change_Requests'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['discontinued_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['discontinued_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['discontinued_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['discontinued_c_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
