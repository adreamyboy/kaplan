...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'modules/SavedSearch/SavedSearchForm.tpl', 54, false),array('modifier', 'default', 'modules/SavedSearch/SavedSearchForm.tpl', 83, false),)), $this); ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 0px none; margin-bottom: 4px">
    <tr valign='top'>
        <td width='34%' align='left' rowspan='4' colspan='2' <?php if ($this->_tpl_vars['orderBySelectOnly']): ?>style="display:none;"<?php endif; ?>>
