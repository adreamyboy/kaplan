<?php /* Smarty version 2.6.29, created on 2022-06-07 09:14:29
         compiled from cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 46, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 320, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 327, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Leads/SearchForm_advanced.tpl', 335, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='date_entered_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'Leads'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='campaign_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CAMPAIGN','module' => 'Leads'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='description_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'Leads'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='current_url_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_URL','module' => 'Leads'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
	<?php if (! empty ( $this->_tpl_vars['fields']['current_url_c_advanced']['value'] )): ?>
	<input type='text' name='<?php echo $this->_tpl_vars['fields']['current_url_c_advanced']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['current_url_c_advanced']['name']; ?>
' size='30' 
	   maxlength='255' value='<?php echo $this->_tpl_vars['fields']['current_url_c_advanced']['value']; ?>
' title='' tabindex=''  >
	<?php else: ?>
	<input type='text' name='<?php echo $this->_tpl_vars['fields']['current_url_c_advanced']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['current_url_c_advanced']['name']; ?>
