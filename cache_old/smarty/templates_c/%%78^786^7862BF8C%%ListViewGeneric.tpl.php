...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/ListView/ListViewGeneric.tpl', 43, false),array('function', 'counter', 'include/ListView/ListViewGeneric.tpl', 127, false),array('function', 'sugar_translate', 'include/ListView/ListViewGeneric.tpl', 156, false),array('function', 'sugar_getimage', 'include/ListView/ListViewGeneric.tpl', 162, false),array('function', 'sugar_ajax_url', 'include/ListView/ListViewGeneric.tpl', 246, false),array('function', 'sugar_evalcolumn_old', 'include/ListView/ListViewGeneric.tpl', 250, false),array('function', 'sugar_field', 'include/ListView/ListViewGeneric.tpl', 252, false),array('modifier', 'replace', 'include/ListView/ListViewGeneric.tpl', 81, false),array('modifier', 'default', 'include/ListView/ListViewGeneric.tpl', 142, false),array('modifier', 'lower', 'include/ListView/ListViewGeneric.tpl', 145, false),array('modifier', 'upper', 'include/ListView/ListViewGeneric.tpl', 149, false),)), $this); ?>
    ...
    <div class="list view listViewEmpty">
        <?php if ($this->_tpl_vars['displayEmptyDataMesssages']): ?>
            <?php if (strlen ( $this->_tpl_vars['query'] ) == 0): ?>
                <?php ob_start(); ?><a
                    href="?module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_action=DetailView"><?php echo $this->_tpl_vars['APP']['LBL_CREATE_BUTTON_LABEL']; ?>
                ...
                <?php ob_start(); ?><a
                    href="?module=Import&action=Step1&import_module=<?php echo $this->_tpl_vars['pageData']['bean']['moduleDir']; ?>
...
&return_action=index"><?php echo $this->_tpl_vars['APP']['LBL_IMPORT']; ?>
                ...
                <?php ob_start(); ?><a target="_blank"
                                              href='?module=Administration&action=SupportPortal&view=documentation&version=<?php echo $this->_tpl_vars['sugar_info']['sugar_version']; ?>
...
?>
                ...
                <?php if ($this->_tpl_vars['colCounter'] == '0'): ?>
                    <?php $this->assign('hiddenclass', ""); ?>
                <?php elseif ($this->_tpl_vars['colCounter'] < '5'): ?>
                    <?php $this->assign('hiddenclass', "hidden-xs"); ?>
                <?php elseif ($this->_tpl_vars['colCounter'] >= '5'): ?>
                    <?php $this->assign('hiddenclass', "hidden-xs hidden-sm hidden-md"); ?>
                <?php endif; ?>
                <?php if ($this->_tpl_vars['colHeader'] == 'NAME' || $this->_tpl_vars['params']['bold']): ?>
                <th scope='col' data-toggle="true" class="<?php echo $this->_tpl_vars['hiddenclass']; ?>
">
                <?php else: ?><th scope='col' data-hide="<?php echo $this->_tpl_vars['datahide']; ?>
" class="<?php echo $this->_tpl_vars['hiddenclass']; ?>
"><?php endif; ?>
...
"
                                   ...
                                   class='checkbox' name='mass[]' value='<?php echo $this->_tpl_vars['rowData']['ID']; ?>
'>
                        <?php endif; ?>
                    </td>
                <?php endif; ?>
...
<?php else: ?>EditView<?php endif; ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('action', ob_get_contents());ob_end_clean(); ?>
                    <td width='2%' nowrap>
                        <?php if ($this->_tpl_vars['pageData']['rowAccess'][$this->_tpl_vars['id']]['edit']): ?>
                            <?php if ($this->_tpl_vars['linkModule'] != 'AOR_Reports'): ?>
