<?php /* Smarty version 2.6.29, created on 2022-06-09 14:00:40
...
<?php endif; ?>
	<tr>
		<td width="25%" rowspan="2" <?php if (! isset ( $this->_tpl_vars['includeContainerCSS'] ) || $this->_tpl_vars['includeContainerCSS']): ?>class="tabDetailViewDL"<?php else: ?>scope="row"<?php endif; ?>><slot>
			<?php echo $this->_tpl_vars['CHECKLIST']; ?>

		</slot></td>
		<td width="75%" <?php if (! isset ( $this->_tpl_vars['includeContainerCSS'] ) || $this->_tpl_vars['includeContainerCSS']): ?>class="tabDetailViewDF"<?php endif; ?>><slot>
