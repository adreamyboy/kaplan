<?php /* Smarty version 2.6.29, created on 2022-06-07 11:10:41
         compiled from cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl', 46, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/GI_Terms/SearchForm_popup_query_form.tpl', 154, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'GI_Terms'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='code_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CODE','module' => 'GI_Terms'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
                        
<?php if (strlen ( $this->_tpl_vars['fields']['code_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['code_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['code_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['code_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['code_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='discontinued_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DISCONTINUED','module' => 'GI_Terms'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
