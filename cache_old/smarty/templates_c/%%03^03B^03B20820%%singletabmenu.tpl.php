<?php /* Smarty version 2.6.29, created on 2022-06-09 14:20:21
...
' class='subTabLink'><?php echo $this->_tpl_vars['tab']['label']; ?>
                                    ...
                                    <?php if (! empty ( $this->_tpl_vars['otherMoreSubMenu'][$this->_tpl_vars['moreSubMenuName']]['tabs'] )): ?>
                                        <td nowrap="nowrap"> | &nbsp;<span class="subTabMore"
                                                                           id="MoreSub<?php echo $this->_tpl_vars['moreSubMenuName']; ?>
PanelHandle"
                                                                           style="margin-left:2px; cursor: pointer; cursor: hand;"
                                                                           align="absmiddle"
                                                                           onmouseover="SUGAR.subpanelUtils.menu.tbspButtonMouseOver(this.id,'','',0);">&gt;&gt;</span>
                                        </td>
                                    <?php endif; ?>
                                    <td width='100%'>&nbsp;</td>
                                </tr>
...
_sp_mm" parentid="MorePanelMenu"
                           onmouseover="hiliteItem(this,'yes'); closeSubMenus(this);"
                           onmouseout="unhiliteItem(this);"><?php echo $this->_tpl_vars['tab']['label']; ?>
</a>
                    <?php endforeach; endif; unset($_from); ?>
                </div>
            <?php endif; ?>
...
PanelMenu"
                               onmouseover="hiliteItem(this,'yes'); closeSubMenus(this);"
                               onmouseout="unhiliteItem(this);"><?php echo $this->_tpl_vars['subtab']['label']; ?>
</a>
                        <?php endforeach; endif; unset($_from); ?>
                    </div>
                <?php endif; ?>
