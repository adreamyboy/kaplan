...
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'custom/include/DetailView/DetailView.tpl', 47, false),array('function', 'sugar_evalcolumn', 'custom/include/DetailView/DetailView.tpl', 133, false),array('function', 'sugar_field', 'custom/include/DetailView/DetailView.tpl', 138, false),array('modifier', 'count', 'custom/include/DetailView/DetailView.tpl', 83, false),)), $this); ?>
{*
/*********************************************************************************
...
?>
	  ...
	  {* ER2012: I can't get this intendation - it is crazy *}
...
&nbsp;
		...
		{* ER2012: Someone who understand this should make it better (if or if blah blah) *}
		<?php if ($this->_tpl_vars['colData']['field']['name'] != ''): ?>
		{else}
