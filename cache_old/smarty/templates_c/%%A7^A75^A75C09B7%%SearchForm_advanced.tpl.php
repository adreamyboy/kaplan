<?php /* Smarty version 2.6.29, created on 2022-06-08 05:36:41
         compiled from cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 36, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 46, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 87, false),array('function', 'sugar_getimage', 'cache/themes/SuiteR/modules/GI_Products_Catalog/SearchForm_advanced.tpl', 377, false),)), $this); ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='web_hidden_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_WEB_HIDDEN','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['web_hidden_c_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['web_hidden_c_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['web_hidden_c_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['web_hidden_c_advanced']['name']; ?>
"   >
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='discontinued_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DISCONTINUED','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
<?php if (strval ( $this->_tpl_vars['fields']['discontinued_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['discontinued_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['discontinued_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['discontinued_advanced']['name']; ?>
"   >
 <option value="" <?php echo $this->_tpl_vars['default']; ?>
></option>
 <option value = "0" <?php echo $this->_tpl_vars['no']; ?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='code_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CODE','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<?php if (strlen ( $this->_tpl_vars['fields']['code_c_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['code_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['code_c_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['code_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['code_c_advanced']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='short_description_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SHORT_DESCRIPTION','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<?php if (empty ( $this->_tpl_vars['fields']['short_description_c_advanced']['value'] )): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['short_description_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['short_description_c_advanced']['value']); ?>
<?php endif; ?>




<textarea  id='<?php echo $this->_tpl_vars['fields']['short_description_c_advanced']['name']; ?>
' name='<?php echo $this->_tpl_vars['fields']['short_description_c_advanced']['name']; ?>
'
rows="4"
cols="20"
title='' tabindex="" 
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='price_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PRICE','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='type_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TYPE','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<?php echo smarty_function_html_options(array('id' => 'type_c_advanced','name' => 'type_c_advanced[]','options' => $this->_tpl_vars['fields']['type_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['type_c_advanced']['value']), $this);?>
...
' class="help-search">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='sequence_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SEQUENCE','module' => 'GI_Products_Catalog'), $this);?>
</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<?php if (strlen ( $this->_tpl_vars['fields']['sequence_c_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sequence_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['sequence_c_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['sequence_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['sequence_c_advanced']['name']; ?>
' size='30' 
