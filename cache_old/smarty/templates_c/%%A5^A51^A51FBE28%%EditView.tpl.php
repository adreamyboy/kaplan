<?php /* Smarty version 2.6.29, created on 2022-06-07 11:36:03
         compiled from cache/themes/SuiteR/modules/Accounts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 38, false),array('modifier', 'default', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 50, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 63, false),array('modifier', 'lookup', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 124, false),array('modifier', 'count', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 226, false),array('function', 'sugar_include', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 44, false),array('function', 'counter', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 49, false),array('function', 'sugar_translate', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 53, false),array('function', 'html_options', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 99, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteR/modules/Accounts/EditView.tpl', 127, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['tier_c']['acl'] < 1): ?>
<td valign="top" id='tier_c_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TIER','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<select name="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" 
title='Tier 1: xxxx, Tier 2: xxxx, Tier 3: xxxx'       
>
<?php if (isset ( $this->_tpl_vars['fields']['tier_c']['value'] ) && $this->_tpl_vars['fields']['tier_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['tier_c']['options'],'selected' => $this->_tpl_vars['fields']['tier_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['tier_c']['options'],'selected' => $this->_tpl_vars['fields']['tier_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['tier_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['tier_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
" 
title='Tier 1: xxxx, Tier 2: xxxx, Tier 3: xxxx'          
...
id="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
...
<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['tier_c']['name']; ?>
');
...
<?php if ($this->_tpl_vars['bean']->field_defs['phone_office']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['industry']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['phone_alternate']['acl'] < 1): ?>
<td valign="top" id='phone_alternate_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE_ALT','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if ($this->_tpl_vars['bean']->field_defs['employees']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['contacts_accounts_1_name']['acl'] < 1): ?>
<td valign="top" id='contacts_accounts_1_name_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTS_ACCOUNTS_1_FROM_CONTACTS_TITLE','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['contacts_accounts_1contacts_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
...
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"contacts_accounts_1contacts_ida","name":"contacts_accounts_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_CONTACTS_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['contacts_accounts_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php if ($this->_tpl_vars['bean']->field_defs['website']['acl'] < 1): ?>
...
<?php if ($this->_tpl_vars['bean']->field_defs['individual_c']['acl'] < 1): ?>
<td valign="top" id='individual_c_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_INDIVIDUAL','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strval ( $this->_tpl_vars['fields']['individual_c']['value'] ) == '1' || strval ( $this->_tpl_vars['fields']['individual_c']['value'] ) == 'yes' || strval ( $this->_tpl_vars['fields']['individual_c']['value'] ) == 'on'): ?> 
<?php $this->assign('checked', 'checked="checked"'); ?>
<?php else: ?>
<?php $this->assign('checked', ""); ?>
<?php endif; ?>
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['individual_c']['name']; ?>
" value="0"> 
<input type="checkbox" id="<?php echo $this->_tpl_vars['fields']['individual_c']['name']; ?>
" 
name="<?php echo $this->_tpl_vars['fields']['individual_c']['name']; ?>
" 
...
<?php if ($this->_tpl_vars['bean']->field_defs['billing_address_country']['acl'] < 1): ?>
<td valign="top" id='billing_address_country_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_COUNTRY','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if ($this->_tpl_vars['bean']->field_defs['billing_address_city']['acl'] < 1): ?>
<td valign="top" id='billing_address_city_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_CITY','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if ($this->_tpl_vars['bean']->field_defs['billing_address_postalcode']['acl'] < 1): ?>
<td valign="top" id='billing_address_postalcode_label' width='12.5%' scope="row">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_POSTALCODE','module' => 'Accounts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php echo '\' );
addToValidate(\'EditView\', \'campaign_name\', \'relate\', true,\''; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'first_invoice_date\', \'kreporter\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_FIRST_INVOICE_DATE','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'individual_c\', \'bool\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_INDIVIDUAL','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'tier_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TIER','module' => 'Accounts','for_js' => true), $this);?>
<?php echo '\' );
