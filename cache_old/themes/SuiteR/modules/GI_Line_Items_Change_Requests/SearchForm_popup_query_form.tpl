...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='GI_Line_Items_Change_Requests'}</label>
                    </td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='limit_to_capacity_c_advanced'>{sugar_translate label='LBL_LIMIT_TO_CAPACITY' module='GI_Line_Items_Change_Requests'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
{if strval($fields.limit_to_capacity_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.limit_to_capacity_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.limit_to_capacity_c_advanced.name}" name="{$fields.limit_to_capacity_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='discontinued_c_advanced'>{sugar_translate label='LBL_DISCONTINUED' module='GI_Line_Items_Change_Requests'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
{if strval($fields.discontinued_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.discontinued_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.discontinued_c_advanced.name}" name="{$fields.discontinued_c_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
