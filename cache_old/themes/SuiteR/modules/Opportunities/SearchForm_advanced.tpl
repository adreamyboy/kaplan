...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='reason_of_loss_c_advanced'>{sugar_translate label='LBL_REASON_OF_LOSS' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{html_options id='reason_of_loss_c_advanced' name='reason_of_loss_c_advanced[]' options=$fields.reason_of_loss_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.reason_of_loss_c_advanced.value}
                    </td>
...
<input type='text' name='{$fields.next_step_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='campaign_name_advanced'>{sugar_translate label='LBL_CAMPAIGN' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{literal}{/literal}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='first_activity_date_c_advanced'>{sugar_translate label='LBL_FIRST_ACTIVITY_DATE' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{assign var="id" value=$fields.first_activity_date_c_advanced.name }

{if isset($smarty.request.first_activity_date_c_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.first_activity_date_c_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<div class="dateTimeRangeChoice" style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.first_activity_date_c_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_first_activity_date_c_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_first_activity_date_c_advanced) && !empty($smarty.request.first_activity_date_c_advanced)}{$smarty.request.first_activity_date_c_advanced}{else}{$smarty.request.range_first_activity_date_c_advanced}{/if}' title=''   size="11" class="dateRangeInput">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.first_activity_date_c_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_first_activity_date_c_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.first_activity_date_c_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_first_activity_date_c_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{rdelim}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='last_activity_date_c_advanced'>{sugar_translate label='LBL_LAST_ACTIVITY_DATE' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{assign var="id" value=$fields.last_activity_date_c_advanced.name }

{if isset($smarty.request.last_activity_date_c_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.last_activity_date_c_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<div class="dateTimeRangeChoice" style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.last_activity_date_c_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_last_activity_date_c_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_last_activity_date_c_advanced) && !empty($smarty.request.last_activity_date_c_advanced)}{$smarty.request.last_activity_date_c_advanced}{else}{$smarty.request.range_last_activity_date_c_advanced}{/if}' title=''   size="11" class="dateRangeInput">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.last_activity_date_c_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_last_activity_date_c_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.last_activity_date_c_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_last_activity_date_c_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{rdelim}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='next_step_date_c_advanced'>{sugar_translate label='LBL_NEXT_STEP_DATE' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{assign var="id" value=$fields.next_step_date_c_advanced.name }

{if isset($smarty.request.next_step_date_c_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.next_step_date_c_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<div class="dateTimeRangeChoice" style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.next_step_date_c_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_next_step_date_c_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_next_step_date_c_advanced) && !empty($smarty.request.next_step_date_c_advanced)}{$smarty.request.next_step_date_c_advanced}{else}{$smarty.request.range_next_step_date_c_advanced}{/if}' title=''   size="11" class="dateRangeInput">
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
{assign var=date_value value=$fields.next_step_date_c_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_next_step_date_c_advanced }' title=''  tabindex='' size="11" class="rangeDateInput">
{capture assign="other_attributes"}align="absmiddle" border="0" id="start_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.next_step_date_c_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_next_step_date_c_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
{capture assign="other_attributes"}align="absmiddle" border="0" id="end_range_{$id}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" alt="$APP.LBL_ENTER_DATE other_attributes=$other_attributes"}
<script type="text/javascript">
Calendar.setup ({ldelim}
...
{rdelim}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='no_of_completed_activities_c_advanced'>{sugar_translate label='LBL_NO_OF_COMPLETED_ACTIVITIES' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.no_of_completed_activities_c_advanced.value) <= 0}
{assign var="value" value=$fields.no_of_completed_activities_c_advanced.default_value }
{else}
{assign var="value" value=$fields.no_of_completed_activities_c_advanced.value }
{/if}

{assign var="id" value=$fields.no_of_completed_activities_c_advanced.name }

{if isset($smarty.request.no_of_completed_activities_c_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.no_of_completed_activities_c_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<span style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" style="width:190px !important;" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.no_of_completed_activities_c_advanced.options selected=$starting_choice}
</select>
<div id="{$id}_range_div" style="{if $starting_choice=='between'}display:none;{else}display:'';{/if}">
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
     
    value='{if empty($smarty.request.range_no_of_completed_activities_c_advanced) && !empty($smarty.request.no_of_completed_activities_c_advanced)}{$smarty.request.no_of_completed_activities_c_advanced}{else}{$smarty.request.range_no_of_completed_activities_c_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_no_of_completed_activities_c_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_no_of_completed_activities_c_advanced }' tabindex=''>    
</div> 
</span>
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='no_of_not_held_activities_c_advanced'>{sugar_translate label='LBL_NO_OF_NOT_HELD_ACTIVITIES' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.no_of_not_held_activities_c_advanced.value) <= 0}
{assign var="value" value=$fields.no_of_not_held_activities_c_advanced.default_value }
{else}
{assign var="value" value=$fields.no_of_not_held_activities_c_advanced.value }
{/if}

{assign var="id" value=$fields.no_of_not_held_activities_c_advanced.name }

{if isset($smarty.request.no_of_not_held_activities_c_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.no_of_not_held_activities_c_advanced_range_choice}
{else}
{assign var="starting_choice" value="="}
{/if}
...
<span style="white-space:nowrap !important;">
<select id="{$id}_range_choice" name="{$id}_range_choice" style="width:190px !important;" onchange="{$id}_range_change(this.value);">
{html_options options=$fields.no_of_not_held_activities_c_advanced.options selected=$starting_choice}
</select>
<div id="{$id}_range_div" style="{if $starting_choice=='between'}display:none;{else}display:'';{/if}">
<input type='text' name='range_{$id}' id='range_{$id}' style='width:75px !important;' size='20' 
     
    value='{if empty($smarty.request.range_no_of_not_held_activities_c_advanced) && !empty($smarty.request.no_of_not_held_activities_c_advanced)}{$smarty.request.no_of_not_held_activities_c_advanced}{else}{$smarty.request.range_no_of_not_held_activities_c_advanced}{/if}' tabindex='' >
</div>
<div id="{$id}_between_range_div" style="{if $starting_choice=='between'}display:'';{else}display:none;{/if}">
<input type='text' name='start_range_{$id}' 
    id='start_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.start_range_no_of_not_held_activities_c_advanced }' tabindex=''>
{$APP.LBL_AND}
<input type='text' name='end_range_{$id}' 
    id='end_range_{$id}' style='width:75px !important;' size='10' 
     
    value='{$smarty.request.end_range_no_of_not_held_activities_c_advanced }' tabindex=''>    
</div> 
</span>
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='terms_and_conditions_c_advanced'>{sugar_translate label='LBL_TERMS_AND_CONDITIONS' module='Opportunities'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
<input type="text" name="{$fields.terms_and_conditions_c_advanced.name}"  class="sqsEnabled"   id="{$fields.terms_and_conditions_c_advanced.name}" size="" value="{$fields.terms_and_conditions_c_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.gi_terms_and_conditions_id_c_advanced.name}" value="{$fields.gi_terms_and_conditions_id_c_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.terms_and_conditions_c_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.terms_and_conditions_c_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"gi_terms_and_conditions_id_c_advanced","name":"terms_and_conditions_c_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.terms_and_conditions_c_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.terms_and_conditions_c_advanced.name}.value = ''; this.form.{$fields.gi_terms_and_conditions_id_c_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
