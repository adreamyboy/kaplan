...
{if $bean->field_defs.call_reason_c.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
{if !$fields.call_reason_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_CALL_REASON' module='Calls'}{/capture}
...
{if is_string($fields.call_reason_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.call_reason_c.name}" value="{ $fields.call_reason_c.options }">
{ $fields.call_reason_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.call_reason_c.name}" value="{ $fields.call_reason_c.value }">
{ $fields.call_reason_c.options[$fields.call_reason_c.value]}
{/if}
{/if}
</td>
...
{if $bean->field_defs.direction.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.date_start.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.parent_name.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.duration_hours.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.reminders.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.reschedule_history.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
