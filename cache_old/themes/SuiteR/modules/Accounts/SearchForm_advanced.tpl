...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='tier_c_advanced'>{sugar_translate label='LBL_TIER' module='Accounts'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{html_options id='tier_c_advanced' name='tier_c_advanced[]' options=$fields.tier_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.tier_c_advanced.value}
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='individual_c_advanced'>{sugar_translate label='LBL_INDIVIDUAL' module='Accounts'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{if strval($fields.individual_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.individual_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.individual_c_advanced.name}" name="{$fields.individual_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='date_entered_advanced'>{sugar_translate label='LBL_DATE_ENTERED' module='Accounts'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
