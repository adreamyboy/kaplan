...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"form_QuickCreate_Accounts","field_to_name_array":{"id":"campaign_id","name":"campaign_name"}}{/literal}, 
"single", 
true
...
addToValidate('form_QuickCreate_Accounts', 'contacts_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CONTACTS_ACCOUNTS_1_FROM_CONTACTS_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'first_invoice_date', 'kreporter', false,'{/literal}{sugar_translate label='LBL_FIRST_INVOICE_DATE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'individual_c', 'bool', false,'{/literal}{sugar_translate label='LBL_INDIVIDUAL' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'tier_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TIER' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('form_QuickCreate_Accounts', 'campaign_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_CAMPAIGN' module='Accounts' for_js=true}{literal}', 'campaign_id' );
