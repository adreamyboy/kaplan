...
{if is_string($fields.tier_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.tier_c.name}" value="{ $fields.tier_c.options }">
{ $fields.tier_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.tier_c.name}" value="{ $fields.tier_c.value }">
{ $fields.tier_c.options[$fields.tier_c.value]}
{/if}
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
{if !$fields.contacts_accounts_1_name.hidden}
...
{if !empty($fields.contacts_accounts_1contacts_ida.value)}
{capture assign="detail_url"}index.php?module=Contacts&action=DetailView&record={$fields.contacts_accounts_1contacts_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="contacts_accounts_1contacts_ida" class="sugar_field" data-id-value="{$fields.contacts_accounts_1contacts_ida.value}">{$fields.contacts_accounts_1_name.value}</span>
{if !empty($fields.contacts_accounts_1contacts_ida.value)}</a>{/if}
{/if}
</td>
...
{/if}
<input type="checkbox" class="checkbox" name="{$fields.individual_c.name}" id="{$fields.individual_c.name}" value="$fields.individual_c.value" disabled="true" {$checked}>
{/if}
</td>
...
{if $bean->field_defs.billing_address_street.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
...
{if $bean->field_defs.shipping_address_street.acl < 1}
{counter name="fieldsUsed"}
<td width='12.5%' scope="row">
