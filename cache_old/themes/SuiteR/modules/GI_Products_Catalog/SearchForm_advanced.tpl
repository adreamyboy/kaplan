...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='GI_Products_Catalog'}</label>
                    </td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='web_hidden_c_advanced'>{sugar_translate label='LBL_WEB_HIDDEN' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{if strval($fields.web_hidden_c_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.web_hidden_c_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.web_hidden_c_advanced.name}" name="{$fields.web_hidden_c_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='discontinued_advanced'>{sugar_translate label='LBL_DISCONTINUED' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
{if strval($fields.discontinued_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.discontinued_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.discontinued_advanced.name}" name="{$fields.discontinued_advanced.name}"   >
 <option value="" {$default}></option>
 <option value = "0" {$no}> {$APP.LBL_SEARCH_DROPDOWN_NO}</option>
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
</select>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='code_c_advanced'>{sugar_translate label='LBL_CODE' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.code_c_advanced.value) <= 0}
{assign var="value" value=$fields.code_c_advanced.default_value }
{else}
{assign var="value" value=$fields.code_c_advanced.value }
{/if}  
<input type='text' name='{$fields.code_c_advanced.name}' 
    id='{$fields.code_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='short_description_c_advanced'>{sugar_translate label='LBL_SHORT_DESCRIPTION' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if empty($fields.short_description_c_advanced.value)}
{assign var="value" value=$fields.short_description_c_advanced.default_value }
{else}
{assign var="value" value=$fields.short_description_c_advanced.value }
{/if}




<textarea  id='{$fields.short_description_c_advanced.name}' name='{$fields.short_description_c_advanced.name}'
rows="4"
cols="20"
title='' tabindex="" 
 >{$value}</textarea>
...
{literal}{/literal}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='price_advanced'>{sugar_translate label='LBL_PRICE' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
...
<input type='text' name='{$fields.price_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='type_c_advanced'>{sugar_translate label='LBL_TYPE' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{html_options id='type_c_advanced' name='type_c_advanced[]' options=$fields.type_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_c_advanced.value}
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='8.3333333333333%'>
                        <label for='sequence_c_advanced'>{sugar_translate label='LBL_SEQUENCE' module='GI_Products_Catalog'}</label>
                    </td>
        <td nowrap="nowrap" width='25%'>
                        
{if strlen($fields.sequence_c_advanced.value) <= 0}
{assign var="value" value=$fields.sequence_c_advanced.default_value }
{else}
{assign var="value" value=$fields.sequence_c_advanced.value }
{/if}  
<input type='text' name='{$fields.sequence_c_advanced.name}' 
    id='{$fields.sequence_c_advanced.name}' size='30' 
