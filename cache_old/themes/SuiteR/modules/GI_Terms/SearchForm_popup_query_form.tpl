...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='GI_Terms'}</label>
                    </td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='code_advanced'>{sugar_translate label='LBL_CODE' module='GI_Terms'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
{/if}  
<input type='text' name='{$fields.code_advanced.name}' 
    id='{$fields.code_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''      >
                    </td>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='discontinued_advanced'>{sugar_translate label='LBL_DISCONTINUED' module='GI_Terms'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
