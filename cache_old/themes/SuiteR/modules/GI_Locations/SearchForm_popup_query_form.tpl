...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='name_advanced'>{sugar_translate label='LBL_NAME' module='GI_Locations'}</label>
                    </td>
...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='assigned_user_id_advanced'>{sugar_translate label='LBL_ASSIGNED_TO' module='GI_Locations'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
...
{html_options id='assigned_user_id_advanced' name='assigned_user_id_advanced[]' options=$fields.assigned_user_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.assigned_user_id_advanced.value}
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='gi_country_gi_locations_1_name_advanced'>{sugar_translate label='LBL_GI_COUNTRY_GI_LOCATIONS_1_FROM_GI_COUNTRY_TITLE' module='GI_Locations'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
                        
<input type="text" name="{$fields.gi_country_gi_locations_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.gi_country_gi_locations_1_name_advanced.name}" size="" value="{$fields.gi_country_gi_locations_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.gi_country_gi_locations_1gi_country_ida_advanced.name}" value="{$fields.gi_country_gi_locations_1gi_country_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.gi_country_gi_locations_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.gi_country_gi_locations_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"popup_query_form","field_to_name_array":{"id":"gi_country_gi_locations_1gi_country_ida_advanced","name":"gi_country_gi_locations_1_name_advanced"}}{/literal}, "single", true);'>{sugar_getimage alt=$app_strings.LBL_ID_FF_SELECT name="id-ff-select" ext=".png" other_attributes=''}</button><button type="button" name="btn_clr_{$fields.gi_country_gi_locations_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.gi_country_gi_locations_1_name_advanced.name}.value = ''; this.form.{$fields.gi_country_gi_locations_1gi_country_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
    ...
    <tr>
        ...
        <td scope="row" nowrap="nowrap" width='10%'>
                        <label for='discontinued_advanced'>{sugar_translate label='LBL_DISCONTINUED' module='GI_Locations'}</label>
                    </td>
        <td nowrap="nowrap" width='30%'>
