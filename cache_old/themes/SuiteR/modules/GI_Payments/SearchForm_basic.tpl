...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='GI_Payments'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='GI_Payments'}</label>
    	</td>
...
value="1" title='' tabindex="" {$checked} >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='verified_c_basic' >{sugar_translate label='LBL_VERIFIED' module='GI_Payments'}</label>
    	</td>
...
{if strval($fields.verified_c_basic.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.verified_c_basic.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.verified_c_basic.name}" name="{$fields.verified_c_basic.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='type_basic' >{sugar_translate label='LBL_TYPE' module='GI_Payments'}</label>
    	</td>
...
{html_options id='type_basic' name='type_basic[]' options=$fields.type_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.type_basic.value}
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='mode_basic' >{sugar_translate label='LBL_MODE' module='GI_Payments'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='mode_basic' name='mode_basic[]' options=$fields.mode_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.mode_basic.value}
   	   	</td>
